...
const resolveCSSVariable = (colorValue: string): string => {
  if (
    ...
    colorValue.startsWith("hsl(var(--") ||
    colorValue.startsWith("rgb(var(--")
  ) {
...
export const SparklesCore = (props: ParticlesProps) => {
  ...
  // Resolve the color when the component mounts or particleColor changes
  useEffect(() => {
    if (typeof window !== "undefined") {
      const color = resolveCSSVariable(particleColor || "#");
