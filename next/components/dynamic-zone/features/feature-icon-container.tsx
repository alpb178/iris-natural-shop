...
export const FeatureIconContainer = ({
  ...
  return (
    <div className=" [perspective:400px] [transform-style:preserve-3d]">
      <div
        className={cn(
          "h-14 w-14 p-[4px] rounded-md bg-gradient-to-b from-muted to-muted/80 mx-auto relative"
        )}
        style={{
      ...
      >
        <div
          className={cn(
            "bg-card rounded-[5px] h-full w-full relative z-20",
            className
          )}
        >
          {children}
        </div>
        <div className="absolute bottom-0 inset-x-0 bg-border opacity-50 rounded-full blur-lg h-4 w-full mx-auto z-30"></div>
